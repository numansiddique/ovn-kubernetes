...
install_ovn() {
  ...
  for n in $MASTER_NODES; do
    kubectl label node "$n" k8s.ovn.org/ovnkube-db=true k8s.ovn.org/ovn-zone=global node-role.kubernetes.io/control-plane="" k8s.ovn.org/ovnkube-master="" --overwrite
