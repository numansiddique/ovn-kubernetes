...
var MetriClusterManagerReadyDuration = prometheus.NewGauge(prometheus.GaugeOpts{
	Namespace: MetricOvnkubeNamespace,
	Subsystem: MetricOvnkubeSubsystemClusterManager,
...
func RegisterClusterManagerBase() {
	...
	prometheus.MustRegister(MetriClusterManagerReadyDuration)
...
// ClusterManager is a collection of metrics that help us understand ovnkube-cluster-manager functions. Call once after
// LE is won.
