...
type networkClusterMgrBase struct {
	kube         kube.Interface
...
// defaultNetworkClusterMgr is the object for managing the default network
// for all the nodes. Listens to the node events.
type defaultNetworkClusterMgr struct {
...
func newDefaultNetworkClusterManager(ovnClient *util.OVNClientset, wf *factory.WatchFactory, stopChan chan struct{},
	wg *sync.WaitGroup) *defaultNetworkClusterMgr {
...
func (ncm *defaultNetworkClusterMgr) initRetryFramework() {
...
func (ncm *defaultNetworkClusterMgr) Start() error {
...
func (ncm *defaultNetworkClusterMgr) Stop() {
	close(ncm.stopChan)
	ncm.wg.Wait()
}

// Run starts the actual watching.
func (ncm *defaultNetworkClusterMgr) Run() error {
...
func (ncm *defaultNetworkClusterMgr) WatchNodes() error {
...
type defaultNetworkClusterMgrEventHandler struct {
...
func (ncm *defaultNetworkClusterMgr) newRetryFramework(objectType reflect.Type) *objretry.RetryFramework {
	resourceHandler := &objretry.ResourceHandler{
		HasUpdateFunc:          hasResourceAnUpdateFunc(objectType),
		NeedsUpdateDuringRetry: false,
		ObjType:                objectType,
		EventHandler: &defaultNetworkClusterMgrEventHandler{
			objType:  objectType,
			ncm:      ncm,
			syncFunc: nil,
		},
...
func (ncm *defaultNetworkClusterMgr) hybridOverlayNodeEnsureSubnet(node *kapi.Node, annotator kube.Annotator) (*net.IPNet, error) {
...
func (ncm *defaultNetworkClusterMgr) releaseHybridOverlayNodeSubnet(nodeName string) {
...
func (ncm *defaultNetworkClusterMgr) addUpdateNodeEvent(node *kapi.Node) error {
...
func (ncm *defaultNetworkClusterMgr) addNode(node *kapi.Node) error {
	return ncm.defaultNetworkController.addUpdateNode(node)
}

func (ncm *defaultNetworkClusterMgr) deleteNode(node *kapi.Node) error {
	if config.HybridOverlay.Enabled {
		ncm.releaseHybridOverlayNodeSubnet(node.Name)
	}
...
func (ncm *defaultNetworkClusterMgr) syncNodes(nodes []interface{}) error {
...
func (h *defaultNetworkClusterMgrEventHandler) AreResourcesEqual(obj1, obj2 interface{}) (bool, error) {
...
func (h *defaultNetworkClusterMgrEventHandler) GetInternalCacheEntry(obj interface{}) interface{} {
	return nil
}

// Given an object key and its type, getResourceFromInformerCache returns the latest state of the object
// from the informers cache.
func (h *defaultNetworkClusterMgrEventHandler) GetResourceFromInformerCache(key string) (interface{}, error) {
	var obj interface{}
	var name string
	var err error
...
func (h *defaultNetworkClusterMgrEventHandler) RecordAddEvent(obj interface{}) {
}

// Given an object and its type, RecordUpdateEvent records the update event on this object.
func (h *defaultNetworkClusterMgrEventHandler) RecordUpdateEvent(obj interface{}) {
}

// Given an object and its type, RecordDeleteEvent records the delete event on this object. Only used for pods now.
func (h *defaultNetworkClusterMgrEventHandler) RecordDeleteEvent(obj interface{}) {
}

func (h *defaultNetworkClusterMgrEventHandler) RecordSuccessEvent(obj interface{}) {
}

// Given an object and its type, RecordErrorEvent records an error event on this object.
// Only used for pods now.
func (h *defaultNetworkClusterMgrEventHandler) RecordErrorEvent(obj interface{}, reason string, err error) {
}

// Given an object and its type, isResourceScheduled returns true if the object has been scheduled.
func (h *defaultNetworkClusterMgrEventHandler) IsResourceScheduled(obj interface{}) bool {
	return true
}

// Given an object and its type, IsObjectInTerminalState returns true if the object is a in terminal state.
func (h *defaultNetworkClusterMgrEventHandler) IsObjectInTerminalState(obj interface{}) bool {
	return false
}
...
func (h *defaultNetworkClusterMgrEventHandler) AddResource(obj interface{}, fromRetryLoop bool) error {
	var err error
...
func (h *defaultNetworkClusterMgrEventHandler) UpdateResource(oldObj, newObj interface{}, inRetryCache bool) error {
	var err error
...
func (h *defaultNetworkClusterMgrEventHandler) DeleteResource(obj, cachedObj interface{}) error {
	switch h.objType {
	case factory.NodeType:
		node, ok := obj.(*kapi.Node)
		if !ok {
...
func (h *defaultNetworkClusterMgrEventHandler) SyncFunc(objs []interface{}) error {
