...
var _ = Describe("Cluster Operations", func() {
	...
	It("test extractDbRemotesFromEndpoint()", func() {
		...
		Expect(nbDBPort).To(Equal("1234"), " test case returned %t instead of 1234", nbDBPort)
		Expect(sbDBPort).To(Equal("4321"), " test case returned %t instead of 4321", sbDBPort)
