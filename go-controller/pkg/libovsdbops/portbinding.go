...
// CreateOrUpdatePortBinding creates or updates a port binding.
// Should be used for testing. ovn-northd will create port bindings
// in real deployments for every logical port.
func CreateOrUpdatePortBinding(sbClient libovsdbclient.Client, portBinding *sbdb.PortBinding) error {
	opModel := operationModel{
		Model:          portBinding,
